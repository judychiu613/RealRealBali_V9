...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Modified API called:', { endpoint, language, limit })
    ...
    if (formattedProperties.length > 0) {
      console.log('Sample property with descriptions:', {
        ...
        description_zh_preview: formattedProperties[0].description_zh?.substring(0, 30) + '...',
        description_en_preview: formattedProperties[0].description_en?.substring(0, 30) + '...'
      })
    }
