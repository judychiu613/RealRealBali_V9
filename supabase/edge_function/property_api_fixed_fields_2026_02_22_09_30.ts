  ...
  try {
    ...
    const processProperty = (property: any) => {
      return {
        ...
        // 图片字段（使用默认图片如果没有）
        image: property.image_url || property.main_image || '/images/default-property.jpg',
        images: property.images ? (Array.isArray(property.images) ? property.images : [property.images]) : [property.image_url || property.main_image || '/images/default-property.jpg']
      };
    };
